...
class ValueSet
  ...
  RESULTS = ValueSet.new('app/resources/lab_codes/ValueSet-qualitative-lab-result-findings.json').freeze
  LAB_CODES = ValueSet.new('app/resources/lab_codes/ValueSet-2.16.840.1.113762.1.4.1114.9.json').freeze
